namespace JiraCopyProject.Models
{
    public class Task
    {
        ...
        public void SetAssigneeId(int? value) { assigneeId = value; }

        public int GetCreatorId() { return creatorId; }
        public void SetCreatorId(int value) { creatorId = value; }

        public int? GetParentTaskId() { return parentTaskId; }
        public void SetParentTaskId(int? value) { parentTaskId = value; }
