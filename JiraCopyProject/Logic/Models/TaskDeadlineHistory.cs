namespace JiraCopyProject.Logic.Models
{
    public class TaskDeadlineHistory
    {
        ...
        public void SetOldDueDate(DateTime value)
        {
            oldDueDate = value;
        }

        public DateTime GetNewDueDate()
        {
            return newDueDate;
        }
        public void SetNewDueDate(DateTime value)
        {
            newDueDate = value;
        }
        ...
        public void SetChangedById(int value)
        {
            changedById = value;
        }
        ...
        public void SetChangedAt(DateTime value)
        {
            changedAt = value;
        }
    }
